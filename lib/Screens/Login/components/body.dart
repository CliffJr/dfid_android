...
import 'package:dfidmobilen/Screens/Dashboardd/dashboardd.dart';
          ...
          children: <Widget>[
            ...
            RoundedButton(
              ...
              press: () {
                ...
                //   _signUp();
                // }
                if (email == 'nurse.solidarmed@gmail.com' &&
                    password == 'nurse@2021') {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                ...
                } else if (email == 'doctor.solidarmed@gmail.com' &&
                    password == 'doctor@2021') {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) {
                        return new Dashboardd();
                      },
                    ),
                  );
                } else {
